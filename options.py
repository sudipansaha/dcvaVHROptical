...
class optionsDCVA():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--thresholding', type=str, default='adaptive', help='adaptive/otsu, adaptive - useful for complex urban areas. Otsu for areas with less spatial complexity')
