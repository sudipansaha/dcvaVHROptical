...
from networks import ResnetGenerator9FeatureFromLayer23
from networks import ResnetGenerator9FeatureFromLayer8
from networks import ResnetGenerator9FeatureFromLayer10
from networks import ResnetGenerator9FeatureFromLayer11
from networks import ResnetGenerator9FeatureFromLayer5
from networks import ResnetGenerator9FeatureFromLayer2
...
netFull=ResnetGenerator(input_nc, output_nc, ngf, norm_layer, use_dropout, 9)
netForFeatureExtractionLayer23=ResnetGenerator9FeatureFromLayer23(input_nc, output_nc, ngf, norm_layer, use_dropout, 9)
netForFeatureExtractionLayer11=ResnetGenerator9FeatureFromLayer11(input_nc, output_nc, ngf, norm_layer, use_dropout, 9)
netForFeatureExtractionLayer10=ResnetGenerator9FeatureFromLayer10(input_nc, output_nc, ngf, norm_layer, use_dropout, 9)
netForFeatureExtractionLayer8=ResnetGenerator9FeatureFromLayer8(input_nc, output_nc, ngf, norm_layer, use_dropout, 9)
netForFeatureExtractionLayer5=ResnetGenerator9FeatureFromLayer5(input_nc, output_nc, ngf, norm_layer, use_dropout, 9)
netForFeatureExtractionLayer2=ResnetGenerator9FeatureFromLayer2(input_nc, output_nc, ngf, norm_layer, use_dropout, 9)
...
netFull.load_state_dict(state_dict)
...
layerWiseFeatureExtractorFunction=[nanVar,nanVar,netForFeatureExtractionLayer2,nanVar,nanVar,netForFeatureExtractionLayer5,nanVar,nanVar,netForFeatureExtractionLayer8,nanVar,\
                            ...
                            nanVar,nanVar,nanVar,netForFeatureExtractionLayer23,nanVar,nanVar,nanVar,netFull]
...
if thresholdingStrategy == 'adaptive':
    for sigma in range(101,202,50):
        ...
        cdMapTemp=morphology.remove_small_objects(cdMapTemp,min_size=512)
